            ...
            <div className="space-y-6">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <a href="mailto:nurpratapkarki@gmail.com" className="text-foreground hover:text-primary transition-colors">
                   nurpratapkarki@gmail.com
                  </a>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <a href="tel:+9779840693765" className="text-foreground hover:text-primary transition-colors">
                    +977 (984) 069 3765
                  </a>
                </div>
              </div>
